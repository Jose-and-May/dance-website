...
if ( class_exists( 'GW_GoPricing' ) ) {
    wp_die( __( 'GW_GoPricing class has already been declared!', 'go_pricing_textdomain' ) );
}
...
register_activation_hook( __FILE__, ['GW_GoPricing', 'activate'] );
register_deactivation_hook( __FILE__, ['GW_GoPricing', 'deactivate'] );
register_uninstall_hook( __FILE__, ['GW_GoPricing', 'uninstall'] );