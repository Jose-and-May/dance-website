...
class Post_Type_Builder {
	...
	function register_single_post_type( $post_type = [] ) {
		...
		$queryable = ( ! empty( $post_type['publicly_queryable'] ) && isset( $post_type['publicly_queryable'] ) ) ?  Utility::get_disp_boolean( $post_type['publicly_queryable'] ) : $public;
	...
	function register_single_taxonomy( $taxonomy = [] ) {
		...
		$publicly_queryable = ( ! empty( $taxonomy['publicly_queryable'] ) && false ===  Utility::get_disp_boolean( $taxonomy['publicly_queryable'] ) ) ? false : true;
