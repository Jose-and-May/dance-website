...
class tp_widget_recent_posts extends WP_Widget {
	function tp_widget_recent_posts() {
		$widget_ops = array('classname' => 'tp_widget_recent_posts', 'description' => __('Display recent posts with featured image','empire') );
		$this->WP_Widget('tp_widget_recent_posts', '* Recent Posts', $widget_ops);
	}
	...
	function widget($args, $instance) {
		...
		foreach($myposts as $post) {
			...
			if($instance['tp_w_recent_posts_display'] == 'excerpt'){		
	...
	function form($instance) {
		...
		<option value="time"'; if($instance['tp_w_recent_posts_display'] == 'time'){print ' selected="selected"';} print '>'.__('Date','empire').'</option>
		<option value="excerpt"'; if($instance['tp_w_recent_posts_display'] == 'excerpt'){print ' selected="selected"';} print '>'.__('Excerpt','empire').'</option>
		</select></p>
