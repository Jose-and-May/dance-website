...
// typography settings
	...
	function tp_theme_typography(){
		...
		if(!empty($_GET['error']) && $_GET['error'] == '1'){
			print '<div id="message" class="error"><p>'.__('Font not found!','empire').'</p></div>';
		}
		...
		print '<div class="wrap">	
			<div class="icon32"><img src="'.$framework_url.'icon-big.png" class="h2_icon" /><br /></div><h2>'.__( 'Typography', 'empire' ).'</h2>	
			...
			<table class="form-table">
				...
				<tr>
					<td><h3>'.__('Recommended Fonts','empire').'</h3></td>
				</tr>				
				
				<tr class="font-face-settings">					
					<td colspan="2">
						<ul class="font-list">
						<li><label><input name="fontface_font_family" type="radio" value="" '; if($tp_fontface_font_family == ''){print 'checked="checked" ';} print '/><span id="preview-1"><h1>PT Sans ('.__('Default','empire').')</h1><br />It\'s a preview sentence with  numbers: 0123456789</span></label></li>
						
						<li><label><input name="fontface_font_family" type="radio" value="Archivo+Narrow" '; if($tp_fontface_font_family == 'Archivo+Narrow'){print 'checked="checked" ';} print '/><span id="preview-6"><h1>Archivo Narrow</h1><br />'.__('It\'s a preview sentence with  numbers: 0123456789','empire').'</span></label></li>				
						<li><label><input name="fontface_font_family" type="radio" value="Brawler" '; if($tp_fontface_font_family == 'Brawler'){print 'checked="checked" ';} print '/><span id="preview-3"><h1>Brawler</h1><br />'.__('It\'s a preview sentence with  numbers: 0123456789','empire').'</span></label></li>
						<li><label><input name="fontface_font_family" type="radio" value="Comfortaa" '; if($tp_fontface_font_family == 'Comfortaa'){print 'checked="checked" ';} print '/><span id="preview-7"><h1>Comfortaa</h1><br />'.__('It\'s a preview sentence with  numbers: 0123456789','empire').'</span></label></li>				
						<li><label><input name="fontface_font_family" type="radio" value="Droid+Serif" '; if($tp_fontface_font_family == 'Droid+Serif'){print 'checked="checked" ';} print '/><span id="preview-4"><h1>Droid Serif</h1><br />'.__('It\'s a preview sentence with  numbers: 0123456789','empire').'</span></label></li>
						<li><label><input name="fontface_font_family" type="radio" value="Fjalla+One" '; if($tp_fontface_font_family == 'Fjalla+One'){print 'checked="checked" ';} print '/><span id="preview-5"><h1>Fjalla One</h1><br />'.__('It\'s a preview sentence with  numbers: 0123456789','empire').'</span></label></li>												
						<li><label><input name="fontface_font_family" type="radio" value="Libre+Baskerville" '; if($tp_fontface_font_family == 'Libre+Baskerville'){print 'checked="checked" ';} print '/><span id="preview-9"><h1>Libre Baskerville</h1><br />'.__('It\'s a preview sentence with  numbers: 0123456789','empire').'</span></label></li>				
						<li><label><input name="fontface_font_family" type="radio" value="Open+Sans" '; if($tp_fontface_font_family == 'Open+Sans'){print 'checked="checked" ';} print '/><span id="preview-2"><h1>Open Sans</h1><br />'.__('It\'s a preview sentence with  numbers: 0123456789','empire').'</span></label></li>						
						<li><label><input name="fontface_font_family" type="radio" value="PT+Sans+Narrow" '; if($tp_fontface_font_family == 'PT+Sans+Narrow'){print 'checked="checked" ';} print '/><span id="preview-8"><h1>PT Sans Narrow</h1><br />'.__('It\'s a preview sentence with  numbers: 0123456789','empire').'</span></label></li>
						<li><label><input name="fontface_font_family" type="radio" value="Roboto+Condensed" '; if($tp_fontface_font_family == 'Roboto+Condensed'){print 'checked="checked" ';} print '/><span id="preview-10"><h1>Roboto Condensed</h1><br />'.__('It\'s a preview sentence with  numbers: 0123456789','empire').'</span></label></li>						
						';
							...
							if(!empty($tp_typography_custom_fonts)){	
								...
								foreach($tp_typography_custom_fonts as $cf){
									...
									<li><label>
										...
										<span id="preview-'.strtolower(str_replace('+','_',$cf)).'"><h1>'.str_replace('+',' ',$cf).' ('.__('Custom','empire').')</h1><br />'.__('It\'s a preview sentence with  numbers: 0123456789','empire').'
										<br /><br /><a href="admin.php?page=tp_theme_typography&remove='.$cf.'">'.__('Click here to remove','empire').'</a>
										</span>
										</label>
									</li>';							
								}
				...
				<tr>
					<td><h3>'.__('Add Your Custom Google Font','empire').'</h3></td>
				</tr>					
				<tr>
					<td>'.__('Just select a font from <a href="http://www.google.com/webfonts" target="_blank">Google Web Fonts</a> directory, type your selected font\'s <strong>exact name</strong> below, hit enter and it will appear in the list!','empire').'</td>
				</tr>
				<tr>					
					<td>
						<label>'.__( 'Google Font Name', 'empire' ).'&nbsp;&nbsp;&nbsp;</label>
				...
				<tr>
					<td><h3>'.__('Advanced Settings','empire').'</h3></td>
				</tr>
					...
					<td width="100%">
						<table id="advanced-fs">
							<tr style="background-color: #f5f5f5;">
								<td width="20%"></td>
								<td width="16%"><strong>'.__('Font Family','empire').'</strong></td>
								<td width="10%"><strong>'.__('Size','empire').'</strong></td>
								<td width="10%"><strong>'.__('Style','empire').'</strong></td>
								<td width=""><strong>'.__('Color','empire').'</strong></td>
								<td width=""><strong>'.__('Hover Color','empire').'</strong></td>
							</tr>
							
							
							<tr>
								<td><strong>'.__('Body text','empire').'</strong></td>
								<td><select name="form-txt-body-font" class="form-as-fontfamily">
									<option value="">-</option>
									<optgroup label="'.__('Recommended Fonts','empire').'">
										...
										<option value="PT+Sans+Narrow"'; if($tp_txt_body_font == 'PT+Sans+Narrow'){ print ' selected="selected"';} print '>PT Sans Narrow</option>
										<option value="Roboto+Condensed"'; if($tp_txt_body_font == 'Roboto+Condensed'){ print ' selected="selected"';} print '>Roboto Condensed</option>
									</optgroup>
									<optgroup label="'.__('Your Custom Fonts','empire').'">
									';
										//load custom fonts
										if(!empty($tp_typography_custom_fonts)){
											if(!is_array($tp_typography_custom_fonts)){$tp_typography_custom_fonts = unserialize($tp_typography_custom_fonts);}
											...
											print '<option value="" style="font-style: italic;">'.__('None added yet','empire').'</option>';
										}
									print '
									</optgroup>
									</select>
								...
								<td><select name="form-txt-body-style">
									...
									print '
									<option value="bold" style="font-weight:bold;"'; if($tp_txt_body_style == 'bold'){print ' selected="selected"';} print '>Bold</option>
									<option value="italic" style="font-style:italic;"'; if($tp_txt_body_style == 'italic'){print ' selected="selected"';} print '>Italic</option>									
									</select>
								</td>
								<td>
									<input type="text" id="color1" class="colorwell" name="form-txt-body-color" maxlength="7" value="'.$tp_txt_body_color.'" />
									<input type="button" id="colorpicker_1" class="button" value="Select color"  />
							...
							<tr class="alternate">
								<td><strong>'.__('Menu','empire').'</strong></td>
								<td><select name="form-txt-menu-font" class="form-as-fontfamily">
									...
									<optgroup label="'.__('Recommended Fonts','empire').'">
										...
										<option value="PT+Sans+Narrow"'; if($tp_txt_menu_font == 'PT+Sans+Narrow'){ print ' selected="selected"';} print '>PT Sans Narrow</option>
								...
								<td><select name="form-txt-menu-style">
									...
									print '
									<option value="bold" style="font-weight:bold;"'; if($tp_txt_menu_style == 'bold'){print ' selected="selected"';} print '>Bold</option>
									<option value="italic" style="font-style:italic;"'; if($tp_txt_menu_style == 'italic'){print ' selected="selected"';} print '>Italic</option>									
									</select>
								</td>
								<td>
									<input type="text" id="color2" class="colorwell" name="form-txt-menu-color" maxlength="7" value="'.$tp_txt_menu_color.'" />
									<input type="button" id="colorpicker_2" class="button" value="Select color"  />
								...
								<td>
									...
									<input type="button" id="colorpicker_3" class="button" value="Select color"  />
									<div id="colorpicker3" class="colorpicker"></div></td>
							</tr>
							
							
							<tr>
								<td><strong>'.__('Link','empire').'</strong></td>
								<td><select name="form-txt-link-font" class="form-as-fontfamily">
									...
									<optgroup label="'.__('Recommended Fonts','empire').'">
										...
										<option value="PT+Sans+Narrow"'; if($tp_txt_link_font == 'PT+Sans+Narrow'){ print ' selected="selected"';} print '>PT Sans Narrow</option>
								...
								<td><select name="form-txt-link-style">
									...
									print '
									<option value="bold" style="font-weight:bold;"'; if($tp_txt_link_style == 'bold'){print ' selected="selected"';} print '>Bold</option>
									<option value="italic" style="font-style:italic;"'; if($tp_txt_link_style == 'italic'){print ' selected="selected"';} print '>Italic</option>									
									</select>
								</td>
								<td>
									<input type="text" id="color4" class="colorwell" name="form-txt-link-color" maxlength="7" value="'.$tp_txt_link_color.'" />
									<input type="button" id="colorpicker_4" class="button" value="Select color"  />
								...
								<td>
									...
									<input type="button" id="colorpicker_5" class="button" value="Select color"  />
							...
							<tr class="alternate">
								<td><strong>'.__('Heading 1','empire').'</strong></td>
								<td><select name="form-txt-h1-font" class="form-as-fontfamily">
									...
									<optgroup label="'.__('Recommended Fonts','empire').'">
										...
										<option value="PT+Sans+Narrow"'; if($tp_txt_h1_font == 'PT+Sans+Narrow'){ print ' selected="selected"';} print '>PT Sans Narrow</option>
								...
								<td><select name="form-txt-h1-style">
									...
									print '
									<option value="bold" style="font-weight:bold;"'; if($tp_txt_h1_style == 'bold'){print ' selected="selected"';} print '>Bold</option>
									<option value="italic" style="font-style:italic;"'; if($tp_txt_h1_style == 'italic'){print ' selected="selected"';} print '>Italic</option>									
									</select>
								</td>
								<td>
									<input type="text" id="color6" class="colorwell" name="form-txt-h1-color" maxlength="7" value="'.$tp_txt_h1_color.'" />
									<input type="button" id="colorpicker_6" class="button" value="Select color"  />
							...
							<tr>
								<td><strong>'.__('Heading 2','empire').'</strong></td>
								<td><select name="form-txt-h2-font" class="form-as-fontfamily">
									...
									<optgroup label="'.__('Recommended Fonts','empire').'">
										...
										<option value="PT+Sans+Narrow"'; if($tp_txt_h2_font == 'PT+Sans+Narrow'){ print ' selected="selected"';} print '>PT Sans Narrow</option>
								...
								<td><select name="form-txt-h2-style">
									...
									print '
									<option value="bold" style="font-weight:bold;"'; if($tp_txt_h2_style == 'bold'){print ' selected="selected"';} print '>Bold</option>
									<option value="italic" style="font-style:italic;"'; if($tp_txt_h2_style == 'italic'){print ' selected="selected"';} print '>Italic</option>									
									</select>
								</td>
								<td>
									<input type="text" id="color7" class="colorwell" name="form-txt-h2-color" maxlength="7" value="'.$tp_txt_h2_color.'" />
									<input type="button" id="colorpicker_7" class="button" value="Select color"  />
							...
							<tr class="alternate">
								<td><strong>'.__('Heading 3','empire').'</strong></td>
								<td><select name="form-txt-h3-font" class="form-as-fontfamily">
									...
									<optgroup label="'.__('Recommended Fonts','empire').'">
										...
										<option value="PT+Sans+Narrow"'; if($tp_txt_h3_font == 'PT+Sans+Narrow'){ print ' selected="selected"';} print '>PT Sans Narrow</option>
								...
								<td><select name="form-txt-h3-style">
									...
									print '
									<option value="bold" style="font-weight:bold;"'; if($tp_txt_h3_style == 'bold'){print ' selected="selected"';} print '>Bold</option>
									<option value="italic" style="font-style:italic;"'; if($tp_txt_h3_style == 'italic'){print ' selected="selected"';} print '>Italic</option>									
									</select>
								</td>
								<td>
									<input type="text" id="color8" class="colorwell" name="form-txt-h3-color" maxlength="7" value="'.$tp_txt_h3_color.'" />
									<input type="button" id="colorpicker_8" class="button" value="Select color"  />
							...
							<tr>
								<td><strong>'.__('Heading 4','empire').'</strong></td>
								<td><select name="form-txt-h4-font" class="form-as-fontfamily">
									...
									<optgroup label="'.__('Recommended Fonts','empire').'">
										...
										<option value="PT+Sans+Narrow"'; if($tp_txt_h4_font == 'PT+Sans+Narrow'){ print ' selected="selected"';} print '>PT Sans Narrow</option>
								...
								<td><select name="form-txt-h4-style">
									...
									print '
									<option value="bold" style="font-weight:bold;"'; if($tp_txt_h4_style == 'bold'){print ' selected="selected"';} print '>Bold</option>
									<option value="italic" style="font-style:italic;"'; if($tp_txt_h4_style == 'italic'){print ' selected="selected"';} print '>Italic</option>									
									</select>
								</td>
								<td>
									<input type="text" id="color9" class="colorwell" name="form-txt-h4-color" maxlength="7" value="'.$tp_txt_h4_color.'" />
									<input type="button" id="colorpicker_9" class="button" value="Select color"  />
							...
							<tr class="alternate">
								<td><strong>'.__('Heading 5','empire').'</strong></td>
								<td><select name="form-txt-h5-font" class="form-as-fontfamily">
									...
									<optgroup label="'.__('Recommended Fonts','empire').'">
										...
										<option value="PT+Sans+Narrow"'; if($tp_txt_h5_font == 'PT+Sans+Narrow'){ print ' selected="selected"';} print '>PT Sans Narrow</option>
								...
								<td><select name="form-txt-h5-style">
									...
									print '
									<option value="bold" style="font-weight:bold;"'; if($tp_txt_h5_style == 'bold'){print ' selected="selected"';} print '>Bold</option>
									<option value="italic" style="font-style:italic;"'; if($tp_txt_h5_style == 'italic'){print ' selected="selected"';} print '>Italic</option>									
									</select>
								</td>
								<td>
									<input type="text" id="color10" class="colorwell" name="form-txt-h5-color" maxlength="7" value="'.$tp_txt_h5_color.'" />
									<input type="button" id="colorpicker_10" class="button" value="Select color"  />
							...
							<tr class="alternate">
								<td><strong>'.__('Heading 6','empire').'</strong></td>
								<td><select name="form-txt-h6-font" class="form-as-fontfamily">
									...
									<optgroup label="'.__('Recommended Fonts','empire').'">
										...
										<option value="PT+Sans+Narrow"'; if($tp_txt_h6_font == 'PT+Sans+Narrow'){ print ' selected="selected"';} print '>PT Sans Narrow</option>
								...
								<td><select name="form-txt-h6-style">
									...
									print '
									<option value="bold" style="font-weight:bold;"'; if($tp_txt_h6_style == 'bold'){print ' selected="selected"';} print '>Bold</option>
									<option value="italic" style="font-style:italic;"'; if($tp_txt_h6_style == 'italic'){print ' selected="selected"';} print '>Italic</option>									
									</select>
								</td>
								<td>
									<input type="text" id="color11" class="colorwell" name="form-txt-h6-color" maxlength="7" value="'.$tp_txt_h6_color.'" />
									<input type="button" id="colorpicker_11" class="button" value="Select color"  />
			...
			<p class="submit"><a href="admin.php?page=tp_theme_typography&reset=1" class="button button-secondary">'.__( 'Reset Defaults', 'empire' ).'</a></p>	
