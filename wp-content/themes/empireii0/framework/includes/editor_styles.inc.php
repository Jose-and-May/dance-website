...
function wps_mce_before_init( $settings ) {
    ...
    $style_formats = array(
		...
		array(
			'title' => __( '1/2 Column', 'empire' ),
			'block' => 'div',
			'wrapper' => 'p',
			'classes' => 'one_half',
			),
		array(
			'title' => __( '1/2 Column (Last in a row)', 'empire' ),
			'block' => 'div',
			'wrapper' => 'p',
			'classes' => 'one_half last',
			),
		array(
			'title' => __( '1/3 Column', 'empire' ),
			'block' => 'div',
			'wrapper' => 'p',
			'classes' => 'one_third',
			),
		array(
			'title' => __( '1/3 Column (Last in a row)', 'empire' ),
			'block' => 'div',
			'wrapper' => 'p',
			'classes' => 'one_third last',
			),
		array(
			'title' => __( '2/3 Column', 'empire' ),
			'block' => 'div',
			'wrapper' => 'p',
			'classes' => 'two_third',
			),
		array(
			'title' => __( '2/3 Column (Last in a row)', 'empire' ),
			'block' => 'div',
			'wrapper' => 'p',
			'classes' => 'two_third last',
			),
		array(
			'title' => __( '1/4 Column', 'empire' ),
			'block' => 'div',
			'wrapper' => 'p',
			'classes' => 'one_fourth',
			),
		array(
			'title' => __( '1/4 Column (Last in a row)', 'empire' ),
			'block' => 'div',
			'wrapper' => 'p',
			'classes' => 'one_fourth last',
			),
		array(
			'title' => __( '3/4 Column', 'empire' ),
			'block' => 'div',
			'wrapper' => 'p',
			'classes' => 'three_fourth',
			),
		array(
			'title' => __( '3/4 Column (Last in a row)', 'empire' ),
			'block' => 'div',
			'wrapper' => 'p',
			'classes' => 'three_fourth last',
			),
		array(
			'title' => __( '1/5 Column', 'empire' ),
			'block' => 'div',
			'wrapper' => 'p',
			'classes' => 'one_fifth',
			),
		array(
			'title' => __( '1/5 Column (Last in a row)', 'empire' ),
			'block' => 'div',
			'wrapper' => 'p',
			'classes' => 'one_fifth last',
			),
		array(
			'title' => __( '2/5 Column', 'empire' ),
			'block' => 'div',
			'wrapper' => 'p',
			'classes' => 'two_fifth',
			),
		array(
			'title' => __( '2/5 Column (Last in a row)', 'empire' ),
			'block' => 'div',
			'wrapper' => 'p',
			'classes' => 'two_fifth last',
			),
		array(
			'title' => __( '3/5 Column', 'empire' ),
			'block' => 'div',
			'wrapper' => 'p',
			'classes' => 'three_fifth',
			),
		array(
			'title' => __( '3/5 Column (Last in a row)', 'empire' ),
			'block' => 'div',
			'wrapper' => 'p',
